...
|---|------------------|------------------|--------|------|
| 1 | [Анализ данных проекта DonorSearch](./DonorSearch/DonorSearch_README.md) | Исследование поведения доноров, а также определение факторов, влияющих на активность доноров.| завершен | `Dbeaver`, `SQL`|
